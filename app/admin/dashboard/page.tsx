  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <StatCard
          title="Total Revenue"
          value={`ÂEGP ${stats.total_revenue.toLocaleString()}`}
          icon="revenue"
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-5">
          ...
          <span className="text-lg font-black font-heading text-[#17583a]">
            ÂEGP {stats.sales_by_day.reduce((s, d) => s + d.revenue, 0).toLocaleString()}
          </span>
        </div>
                ...
                <div key={p.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <p className="text-sm font-bold text-[#17583a]">ÂEGP {p.revenue.toLocaleString()}</p>
                    </div>
              ...
              return (
                <div key={log.id} className="flex items-start gap-3">
                  <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                    isStock ? "bg-amber-50 text-amber-600" : "bg-[#e8f3ec] text-[#17583a]"
                  }`}>
